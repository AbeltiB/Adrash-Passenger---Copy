...
export class BookingService {
  ...
  create(input: CreateBookingDTO, idempotencyKey?: string, signal?: AbortSignal) { return bookingRepository.create(input, idempotencyKey, signal); }
}
