    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {method && (
          <View style={styles.phoneBox}>
            ...
            <TextInput style={styles.input} keyboardType="phone-pad" value={phone} onChangeText={setPhone} placeholderTextColor={Colors.text.disabled} />
      ...
      <View style={styles.footer}>
        <Pressable
          ...
          onPress={() => method && router.push('/(tabs)/booking/waiting')}
          disabled={!method}
        >
...
const styles = StyleSheet.create({
  ...
  method: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md, backgroundColor: Colors.background.primary, borderRadius: BorderRadius.lg, padding: Spacing.md, ...Shadow.sm, borderWidth: 1.5, borderColor: 'transparent' },
  ...
  input: { borderWidth: 1, borderColor: Colors.border.medium, borderRadius: BorderRadius.md, paddingHorizontal: Spacing.md, paddingVertical: 12, fontSize: 15, backgroundColor: Colors.background.primary, color: Colors.text.primary },
